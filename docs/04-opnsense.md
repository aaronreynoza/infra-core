...
├── Enable: ✓
├── Range: REDACTED_VLAN_IP0 - 10.10.10.200
...
XX:XX:XX:XX:XX:01    REDACTED_K8S_API    prod-cp-01
...
```
Host        Domain              IP
argocd      prod.homelab.local  REDACTED_K8S_API
grafana     prod.homelab.local  REDACTED_K8S_API
harbor      prod.homelab.local  REDACTED_K8S_API
